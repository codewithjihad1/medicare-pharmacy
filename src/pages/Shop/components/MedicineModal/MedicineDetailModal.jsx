                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-gray-900 dark:text-white">{medicine.company}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Category</p>
                                    <p className="text-gray-900 dark:text-white capitalize">{medicine.category}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Unit</p>
                                    <p className="text-gray-900 dark:text-white">{medicine.massUnit}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Stock</p>
                                    <p className="text-gray-900 dark:text-white">{medicine.stockQuantity} units</p>
                                </div>
                            </div>
