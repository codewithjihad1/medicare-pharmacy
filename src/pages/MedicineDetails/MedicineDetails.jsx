                    ...
                    <div className="space-y-6" data-aos="fade-left">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400 mb-4">
                                <span className="font-medium">Generic Name:</span> {medicine.genericName}
                            </p>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                            ...
                            {medicine.discount > 0 && (
                                <p className="text-green-600 dark:text-green-400 font-medium">
                                    You save ${discountAmount.toFixed(2)} per unit!
                                </p>
                            )}
                        </div>
                        ...
                        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                            ...
                            <div className="flex items-center gap-3">
                                <img
                                    ...
                                    alt={medicine.seller.displayName}
                                    className="w-10 h-10 rounded-full"
                                />
                                <div>
                                    <p className="font-medium text-gray-900 dark:text-white">
                                        {medicine.seller.displayName}
                                    </p>
                                    ...
                                    initialReviews={[
                                        {
                                            ...
                                            rating: 5,
                                            title: 'Excellent quality medicine',
                                            comment: 'This medicine worked exactly as described. Fast delivery and genuine product. Highly recommended!',
                                            date: '2024-01-15',
                                            helpful: 12,
                                            notHelpful: 1
                                        },
                                        {
                                            ...
                                            comment: 'Effective medicine at a reasonable price. Packaging was secure and delivery was prompt.',
                                            date: '2024-01-10',
                                            helpful: 8,
                                            notHelpful: 0
                                        }
